                ...
                <div x-data="{ open: false, timer: null }" 
                    ...
                    <div x-show="open" 
                        ...
                        <div class="rounded-2xl bg-white p-2 shadow-2xl ring-1 ring-slate-900/10 text-slate-800 tracking-normal normal-case font-medium">
                            ...
                            <a href="{{ route('home') }}#denah" @click="open = false" class="flex items-center gap-2.5 rounded-xl px-3.5 py-2.5 text-xs font-semibold bg-sky-50 text-blue-700 transition">
